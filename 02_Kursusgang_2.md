...
Du kan hente en oversigt over MySQL's datatyper her: [Datatyper](https://www.w3schools.com/mysql/mysql_datatypes.asp)
...
Projekt del 2 afleveres (som en EXCEL-fil)
